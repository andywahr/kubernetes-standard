...
resource "azurerm_user_assigned_identity" "aksPodIdentity" {
  name                = "aks-KuberentesStandard-${var.namePrefix}"
  location            = "${var.location}"
  resource_group_name = "${var.resourceGroupName}"

  name  = "aks-kubstd-${var.namePrefix}"
}
...
resource "azurerm_container_registry" "acr" {
  name                = "acrKuberentesStandard${var.namePrefix}"
  location            = "${var.location}"
  resource_group_name = "${var.resourceGroupName}"
  admin_enabled       = false
  sku                 = "Standard"
...
resource "azurerm_kubernetes_cluster" "aks" {
  ...
  location            = "${var.location}"
  resource_group_name = "${var.resourceGroupName}"
  dns_prefix          = "aks-KuberentesStandard-${var.namePrefix}"
